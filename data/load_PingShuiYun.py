...
class LoadPingShuiYun(object):
    ...
    def __init__(self):
        pingshuiyun_path = '/Users/koprvhdix/Projects/PoemTools/data/PingShuiYun'
            ...
            for character in line[:-1]:
                ...
                if not_stop:
                    if character not in self.pingshuiyun_dict:
                        self.pingshuiyun_dict[character] = [[], []]
                    if tonal < 3:
                        self.pingshuiyun_dict[character][0].append('P')
                        self.pingshuiyun_dict[character][1].append(rhyming)
                    else:
                        self.pingshuiyun_dict[character][0].append('Z')
